...
function sydney_slider_button() {
    ...
    if ($slider_button) {
        ...
        return '<input type="text" name="search" id="search" class="search-postal search-txt"><input type="submit" name="Submit" class="roll-button button-slider search-btn" id="submit-search" value="Search">';
    }
